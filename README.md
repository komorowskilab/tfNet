...
Here you can download the source code, modify it according to your needs etc. If you just need to run tfNet they you might prefer to download the executable tfNet_x64.exe or tfNet_x86.exe.
</p>
